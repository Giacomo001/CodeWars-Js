...
petition to get the association to build the wall. Unfortunately for Don Drumphet, he cannot read very 
well, has a very limited attention span, and can only remember two letters from each of his neighbors’ 
names. As he collects signatures, he insists that his neighbors keep truncating their names until two letters 
...
//Solution using array's methods
function whoIsPaying(name){
  return (name.length <= 2) ? Array(name) : Array(name, name.slice(0, 2));
}
