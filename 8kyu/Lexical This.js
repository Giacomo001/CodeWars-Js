...
Return the person object with the Name, Friends and FillFriends function filled out which will fill the 
input into the Friends property.
*/
...
//Solution without loops and with spread operator
var Person = function(){
  var person = {
    _name: "Leroy",
    _friends: [],
