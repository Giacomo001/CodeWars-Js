...
// Solutions with ternary operators
function setAlarm(employed, vacation){
    return employed ? !vacation : false;
}

//Solutions with logical operators
const setAlarm = (employed, vacation) => employed && !vacation;  //return true only when 'employed' === true and 'vacation' === false
