...
If the character is "+" , "-", "*", or "/", the function will return the result of the corresponding 
mathematical function on the two numbers. 
...
function calculate(num1, operation, num2) {
 var operators = ['+', '-', '*', '/']
 if(!operators.includes(operation)) return null
...
//Short solution even though 'eval' is not always safe to use
function calculate(num1, operation, num2) {
  var operators = ['+', '-', '*', '/']
  if(!operators.includes(operation)) return null
